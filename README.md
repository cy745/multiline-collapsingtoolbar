...
[![](https://jitpack.io/v/cy745/multiline-collapsingtoolbar.svg)](https://jitpack.io/#cy745/multiline-collapsingtoolbar)
...
```gradle
dependencies {
    implement 'com.github.cy745:multiline-collapsingtoolbar:1.7.3'
}
```
